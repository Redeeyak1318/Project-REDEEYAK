...
export function TimelineItem({
  ...
  return (
    <li className="relative flex gap-4 md:gap-8 pb-8 md:pb-12 last:pb-0">
      <div className="relative flex flex-col items-center pt-8 md:pt-10">
        <div 
          className="absolute w-px bg-border top-0 bottom-0 [li:first-child_&]:top-8 md:[li:first-child_&]:top-10 [li:last-child_&]:bottom-auto [li:last-child_&]:h-8 md:[li:last-child_&]:h-10 [li:only-child_&]:hidden" 
          aria-hidden="true" 
        />
        <div 
          className="relative h-4 w-4 shrink-0 rounded-full border bg-primary shadow-sm z-10" 
          aria-hidden="true" 
        />
      </div>

      <div className="flex-1 rounded-2xl border bg-card p-6 md:p-8 shadow-sm flex flex-col gap-4">
