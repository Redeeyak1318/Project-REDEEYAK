...
export const SkillCard = ({ skill, className, ...props }: SkillCardProps) => {
  ...
  return (
    <div
      className={cn(
        "group/card flex items-center justify-center rounded-xl border px-5 py-4 transition-all motion-reduce:transition-none duration-300 ease-out motion-safe:hover:scale-[1.02] hover:shadow-md hover:border-border/80 motion-reduce:transition-none motion-reduce:hover:scale-100",
        isExploring
