...
export const ContactCTA = ({
  ...
  return (
    <div
      ...
      className={cn(
        "relative overflow-hidden rounded-3xl border border-border/50 bg-card/80 p-8 sm:p-10 lg:p-12 text-center backdrop-blur-sm shadow-sm transition-all motion-reduce:transition-none duration-300 ease-out motion-safe:hover:scale-[1.02] hover:border-border/80 hover:shadow-md motion-reduce:hover:scale-100 flex flex-col items-center gap-6 lg:gap-8",
        className
      )}
      {...props}
    >
